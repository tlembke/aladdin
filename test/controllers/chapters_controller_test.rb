...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { chapter: @chapter.chapter, position: @chapter.position, section_id: @chapter.section_id }
    end
  ...
  test "should update chapter" do
    patch :update, id: @chapter, chapter: { chapter: @chapter.chapter, position: @chapter.position, section_id: @chapter.section_id }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
