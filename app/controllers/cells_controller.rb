class CellsController < ApplicationController
  before_action :set_cell, only: [:show, :edit, :update, :destroy, :toggle]
  ...
  def toggle
        value="0"
        if @cell.value == nil or @cell.value == "0"
            value="1"
        end
        @cell.update_attribute(:value, value)
  ...
  private
    ...
    def cell_params
      params.require(:cell).permit(:register_id, :patient_id, :header_id, :value, :date, :note)
    end
end
